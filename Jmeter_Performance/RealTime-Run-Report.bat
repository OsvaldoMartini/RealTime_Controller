...
SET JMETER=D:\Installed\apache-jmeter-5.4.3\bin\jmeter
...
:: WORK DIRS
SET WORK_DIR=D:\Projects\RealTime_Controller\Jmeter_Performance
...
:: WORK FILES
SET TEST_PLAN_FILE=%WORK_DIR%\RealTime_Pattern_RestController.jmx
